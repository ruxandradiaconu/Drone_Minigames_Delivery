...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 aux = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 0);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 aux = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(aux));

            aux = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 aux = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(aux));

            aux = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(up, 0);
            forward = glm::normalize(glm::vec3(aux));
