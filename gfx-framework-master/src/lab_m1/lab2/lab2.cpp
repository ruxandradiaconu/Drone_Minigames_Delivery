...
void Lab2::Init()
{
...

    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6))
        };

        vector<unsigned int> indices2 =
        {
            //0, 1, 2,    // indices for first triangle
            //0, 1, 4,    // indices for second triangle
            //2, 0 ,4,
            //4, 2, 1
            0,3,1,
            0,1,2,
        ...
        meshes["tetraedru"] = new Mesh("generated tetra 1");
        meshes["tetraedru"]->InitFromData(vertices2, indices2);

        // Actually create the mesh from the data
        CreateMesh("obj2", vertices2, indices2);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices3
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0, 0.6))
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-2.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["obj2"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(2.5f, 0.5f, 0), glm::vec3(0.25f));
